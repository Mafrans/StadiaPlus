...
var ForceResolution = /** @class */ (function (_super) {
    ...
    ForceResolution.setResolution = function (resolution) {
        ...
        var stadiaPerormance = { HD: 2, FHD: 3, WQHD: 4, UHD_4K: 4 };
         ...
         * */
        var perf = JSON.stringify({ "data": "[" + performanceInject + ",2]", "creation": Date.now() });
